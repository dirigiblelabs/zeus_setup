...
var servicesDao = require('zeus/services/dao/servicesDao');
    ...
    if (!hasConflictingParameters(id, count, metadata, httpResponse)) {
        if (id) {
            ...
            if (entity !== null) {
                ...
                sendResponse(httpResponse, httpResponse.NOT_FOUND, 'text/plain', 'No entity found with \'service_id\'=' + id);
            }
        } else if (count !== null) {
            ...
            var services = servicesDao.list(limit, offset, sort, desc);
...
function handlePutRequest(httpRequest, httpResponse) {
    var entity = getRequestBody(httpRequest);
    var id = getIdParameter(httpRequest, xss);
    id = id !== null ? id : entity.service_id;
    if (id !== null) {
        ...
        sendResponse(httpResponse, httpResponse.PRECONDITION_FAILED, 'text/plain', 'Expected \'service_id\' parameter is missing!');
    }
...
function getIdParameter(httpRequest, xss) {
    ...
    id = id !== null ? id : xss.escapeSql(httpRequest.getParameter('service_id'));
    return id;
}
